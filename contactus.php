	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>Ansar Abbas<h2><h4>Studied BSCS in Computer Science</h4>
							<h5>The Islamia University Of Bahawalpur Baghdad Campus</h5>
						<p>https://www.facebook.com/profile.php?id=100078503678606&mibextid=ZbWKwL <br>
							cell: +92 3166906297</p><br>
				</article>
			</div>
			<div class="col-md-6">
