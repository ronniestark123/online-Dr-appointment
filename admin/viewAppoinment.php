				...
				<?php 
					...
					if($count>=1){
						...
						while($row=mysqli_fetch_array($result)){
								...
								echo "<td>".$row['tyme']."</td>";
								echo "<td><a href='updateAppointment.php?s=".$row['booking_id']."'><input type='button' Value='Update'></a><a href='deleteAppointment.php?s=".$row['booking_id']."'><input type='button' Value='Delete'></a></td>";
